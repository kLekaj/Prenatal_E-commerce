<div class=" lg:w-[88%] w-[85%] mx-5 mx-auto">
    <div class="pb-2 flex justify-between items-center md:space-x-16">
        <div class="flex items-center md:space-x-8">
            ...
            <div>
                {{--                              Trova il negozio and the location logo for desktop  --}}
                <a class="z-10 inline-flex items-center justify-center px-2 md:px-4 py-2 lg:text-[#52762B] focus:outline-none text-[9px]">
        ...
        <div class="flex-grow flex-shrink ">
            <form class="my-[1px]" action="{{ URL::current() }}" method="GET">
                <div class="flex items-center border-b border-gray-800 py-1">
                    ...
                    <input class="appearance-none bg-transparent border-none w-full text-base font-normal text-black placeholder-black mr-3 py-1 px-2 focus:outline-none"
                           type="text"
                           name="search[]"
                    ...
                    <button
                        ...
                        aria-label="Cerca">
                        <svg width="22.747" height="23.312" viewBox="0 0 22.747 23.312" class="w-6 h-6">
        ...
        <div>
            {{--                                human design and bag for desktop--}}
            <div
                x-data="{ open: false }"
                class="-mr-3 flex-grow flex-shrink flex justify-end items-center">
                <div class="relative z-5 " >
                    <span class="relative z-10 ">
                        <button
                            x-on:click="open = ! open"
                            title="Toggle User Account" class="inline-flex items-center justify-center p-2 text-gray-900 focus:text-black focus:bg-gray-100 focus:outline-none">
                            <span class="sr-only">Toggle User Account</span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 23 23" class="w-6 h-6">
                                <g   transform="translate(-1356.95 -64.86)">
                                    <path  data-name="Path 683" d="M1368.45,316.36a4.857,4.857,0,0,1-4.852-4.852,4.986,4.986,0,0,1,2.248-4.092,4.575,4.575,0,0,1,2.6-.759,5.047,5.047,0,0,1,3.033,1.067,4.7,4.7,0,0,1,1.819,3.784A4.857,4.857,0,0,1,1368.45,316.36Zm8.132,3.368a11.467,11.467,0,0,0-4.37-2.741,6.648,6.648,0,1,0-7.524,0,11.518,11.518,0,0,0-7.738,10.873h1.8a9.7,9.7,0,0,1,19.406,0h1.8a11.849,11.849,0,0,0-.989-4.681A11.085,11.085,0,0,0,1376.582,319.728Z" transform="translate(0 -240)"></path>
                                </g>
                            </svg>
                        </button>
                    </span>
                    ...
                    <div
                        ...
                        class=" bg-red-100  z-10   absolute top-full right-0 w-max max-w-xs md:max-w-sm" >
                                    ...
                                    <div class="py-6 bg-white">
                                        <div class="container text-center">
                                            ...
                                            <div class="flex items-center justify-center mt-4">
                                                <span class="mb-0 text-[#E72B6F] text-sm font-medium mr-1 block">Nuovo su Prénatal?</span>
                                                <a href="/register">
                                                    <span class="text-[#E72B6F] text-sm font-medium border-b border-double border-1 border-[#E72B6F]">Registrati qui</span>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                ...
                <span>
                    <div class="relative z-5 " >
                        <span class="relative z-10 ">
                            <button title="Toggle Cart" class="inline-flex items-center justify-center p-2 text-gray-700 focus:text-black focus:bg-gray-100 focus:outline-none">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22.844" height="26.308" viewBox="0 0 22.844 26.308" fill="currentColor" class="w-6 h-6 print:hidden text-white lg:text-gray-700">
                        ...
                        <div class="absolute  z-10 transition duration-150 ease-in transform opacity-0 translate-y-4 pointer-events-none top-full right-0 w-max max-w-xs md:max-w-sm" >
                            <div class="relative" style="max-width: 310px">
                        ...
                        <div class="fixed inset-0 bg-black transition duration-150 opacity-0 pointer-events-none"></div>
                    </div>
                </span>
            </div>
        </div>
