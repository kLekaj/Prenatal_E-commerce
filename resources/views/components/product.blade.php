                    ...
                    <div class="flex flex-wrap -m-2">
                        ...
                        @foreach($posts['data'] as $key=>$value)
                               <div id="posts" class=" w-1/2 p-2 xs:w-1/2 lg:w-1/3 xl:w-1/4"
                                ...
                                <div
                                    class=" mx-5 mx-auto " >
                                    <div class="group-hover:pointer-events-auto transform md:group-hover:bg-white md:group-hover:z-40 md:group-hover:scale-105 transition duration-300 ease-in-out relative"
                                         @mouseover="open = true">
                                                <div class="w-full border border-gray-200  md:group-hover:border-transparent z-0">
                                                    <div class="">
                                                            ...
                                                            <div
                                                                ...
                                                                @if(empty($value['gallery']))
                                                                        <a class="w-full aspect-3/4">
                                                                            <div class=" left-0 top-0 w-full h-full">
                                                                                <img  class="object-cover w-full max-h-[314px]"
                                                                ...
                                                                @else
                                                                    @foreach( $value['gallery'] as $k=>$i)
                                                                        <div class="swiper-slide w-full p-5 h-full">
                                                                            <a class="w-full aspect-3/4">
...
{{--                pjesa e fundit kur esht hover--}}
        ...
        <div class="pb-12">
            <div
                 class="flex flex-col items-center text-xs mt-11 sm:mt-20">
                <p class="text-black">
                    Hai visto
                    <span data-count="">{{ $posts['current_page']*$posts['per_page'] }}</span>
                    di
                    {{ $posts['total'] }}
                    articoli
                </p>
                <button
                    onclick="location.href='{{ $posts['next_page_url'] }}'"
